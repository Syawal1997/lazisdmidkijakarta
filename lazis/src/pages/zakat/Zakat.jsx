...
const ZakatPage = () => (
    <div className="zw-page">
        <style>{`
      .zw-page { font-family: 'Segoe UI', sans-serif; background: #f9fafb; }
      ...
      .zw-hero-title span { color: #34d399; }
      ...
      .zw-btn-primary:hover { transform: translateY(-2px); box-shadow: 0 8px 20px rgba(0,0,0,.2); color: #065f46; }
      .zw-btn-outline {
      ...
      .zw-section-label { font-size: .75rem; font-weight: 700; letter-spacing: .12em; text-transform: uppercase; color: #059669; margin-bottom: .3rem; }
      .zw-section-title { font-size: 1.8rem; font-weight: 800; color: #064e3b; margin: 0 0 .4rem; }
      ...
      .zw-keunggulan-card {
        ...
        box-shadow: 0 3px 14px rgba(0,0,0,.07); border: 1px solid #ecfdf5;
        transition: transform .2s, box-shadow .2s;
      }
      .zw-keunggulan-card:hover { transform: translateY(-4px); box-shadow: 0 8px 24px rgba(16,185,129,.12); }
      .zw-keunggulan-icon { font-size: 2rem; margin-bottom: .7rem; }
      .zw-keunggulan-title { font-size: .93rem; font-weight: 700; color: #065f46; margin: 0 0 .4rem; }
      .zw-keunggulan-desc  { font-size: .8rem; color: #666; line-height: 1.55; margin: 0; }

      /* ── Jenis Zakat Grid ── */
      .zw-bg-light { background: #f0fdf4; }
      ...
      .zw-jenis-card {
        ...
        box-shadow: 0 2px 10px rgba(0,0,0,.06); border-top: 3px solid #10b981;
        transition: transform .2s, box-shadow .2s; cursor: default;
      }
      .zw-jenis-card:hover { transform: translateY(-4px); box-shadow: 0 8px 20px rgba(16,185,129,.14); }
      .zw-jenis-icon  { font-size: 1.8rem; margin-bottom: .5rem; }
      .zw-jenis-title { font-size: .83rem; font-weight: 700; color: #065f46; margin: 0 0 .4rem; }
      ...
      .zw-jenis-badge {
        ...
        background: #ecfdf5; color: #059669; padding: .15rem .5rem; border-radius: 50px;
      }
